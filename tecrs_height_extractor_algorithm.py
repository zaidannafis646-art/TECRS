...
class TecrsHeightExtractorAlgorithm(QgsProcessingAlgorithm):
    # --- 1. DEFINE PLUGIN UI INPUTS ---
    BUILDINGS = 'BUILDINGS'
    SHADOWS = 'SHADOWS'
    ...
    def initAlgorithm(self, config=None):
        self.addParameter(QgsProcessingParameterFeatureSource(self.BUILDINGS, self.tr('Building Footprints (Shapefile)'), [QgsProcessing.TypeVectorPolygon]))
        self.addParameter(QgsProcessingParameterFeatureSource(self.SHADOWS, self.tr('Shadow Polygons (Shapefile)'), [QgsProcessing.TypeVectorPolygon]))
        
        # Time Parameters
        self.addParameter(QgsProcessingParameterDateTime(self.IMAGE_TIME, self.tr('Image Acquisition Date & Time'), type=QgsProcessingParameterDateTime.DateTime))
        self.addParameter(QgsProcessingParameterNumber(self.TZ_OFFSET, self.tr('Timezone Offset of Input Time from UTC (e.g., +3 for Dammam)'), type=QgsProcessingParameterNumber.Double, defaultValue=0.0))
        
        self.addParameter(QgsProcessingParameterFeatureSink(self.OUTPUT, self.tr('Buildings with Height')))
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        # --- DATE-TIME PARSING & TIMEZONE CORRECTION ---
        try:
        ...
        # --- DIRECTIONAL MEASUREMENT (VERTEX COMB METHOD) ---
    ...
    def displayName(self):
        return self.tr('TECRS Building Height Extractor')
    ...
    def createInstance(self):
        return TecrsHeightExtractorAlgorithm()